...
{
	GLCD_SetPixel_16bpp(Xpos,Ypos,0xf800);     /* 中心点 */
	GLCD_SetPixel_16bpp(Xpos+1,Ypos,0xf800);
	GLCD_SetPixel_16bpp(Xpos,Ypos+1,0xf800);
	GLCD_SetPixel_16bpp(Xpos+1,Ypos+1,0xf800);	
}	
